...
<head>
    ...
    <title>确认订单-华强北商城</title>
    <link rel="stylesheet" href="http://s2.hqbcdn.com/??assets/v4/css/base.css,assets/v4/css/public-new.css,lib/dialog/skins/dialog.css?t=20141015" />          <link rel="stylesheet" type="text/css" href="http://s.hqbcdn.com/assets/v4/css/emoji.css?t=20140902" />
            <link rel="stylesheet" href="http://s.hqbcdn.com/assets/v4/css/process/tradeOrder-1.0.0.css?t=20150129" />
            ...
            <div class="pay-nav-con">
                <label for="alipay">
                              <span class="bankimg">
                                  ...
                                  <img disabled="disabled"  src="http://s.hqbcdn.com/assets/v1/images/bank/alipay_1.gif" />
                              </span>
                </label>
...
<!-- S 套餐 -->
    <!-- E 套餐 -->
<input type="hidden" name="tradeType" value="1">                        </table>
        ...
        <div class="order-total">
            ...
            <div class="order-total-con"  style="display: block;">
                    ...
                    <div class="coup-wrapper">
                        ...
                        <div class="coup-btns">
                            <input type="text" class="coup-text" class="coup-text" />
                            <span class="coup-btn">确定</span>
                            <i class="re_tips"></i>
                        </div>
                    </div>
            ...
            <div class="order-info-left">
                ...
                <div class="order-info-bottom">
                    <div class="order-time">
                        <i class="order-time-icon"></i><span class="order-time-text">商品库存有限，请在<i>59分59秒</i>内提交订单</span>
                    </div>
                                            <span class="order-info-fenqi">分期付款最低<i class="low-fenqi">&yen;488/月</i></span>
                                    </div>
            </div>
...
<!--E footer -->    <div class="simple-footer">
...
<script>
    ...
    ga('set', 'UA-30148206-1',  {'userId': '2002112789'});
    ga('send', 'pageview');
</script>
...
<script type="text/javascript">
    ...
    <script type="text/javascript" src="http://s.hqbcdn.com/build/assets/v4/script/process/order-1.0.0.min.js?t=20160712"></script>
