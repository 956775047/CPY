      ...
      <div class="uc_main cfix">
                    ...
                    <td colspan="6">
                      <span class="order-num">
                        <label for="154184834332010">订单编号：
                          <a target="" href=''>{{$row->order_num}}</a></label>
                      </span>
                      <span class="deal-time"></span></td>
                  </tr>
                  <tr class="order-item">
                    <td>
                      ...
                      <div class="info_title">
                        <a href="" class="link_blue" target="">{{$row->name}}</a>
        ...
        <div class="uc_left_sub">
          ...
          <dl class="sub_box" id="play_okqhb">
            ...
            <dd>
              <a href="http://my.okhqb.com/my/point.html" target="_self" title="我的小强币">小强币</a>
            </dd>
            <dd>
          ...
          <dl class="sub_box">
            ...
            <dd class="on">
              <a href="/order" class="sub_cur" title="我的订单">我的订单</a></dd>
            <dd>
