...
<div class="eval_box">
    ...
    <div class="eval_r">
        <div class="goods_titlebox">
         ...
         @foreach($data as $row)
        <form action="/tjpj/{{$row->id}}">
         @endforeach
        <div class="eval_area">
         
            <div class="eval_sta">             
                评分: <span class="star"></span><span class="star"></span><span class="star"></span><span class="star"></span><span class="star"></span>
            </div>
            <div class="ebor"><textarea class="ebox" name="descr"></textarea><p class="f_text">满意，好评，支持小强！</p>
            </div>

            <span class="t_limit">您还可以输入<strong style="color:#ff7818;">255</strong>个字</span>  

           <!--  <a class="eval_smit" href="javascript:void(0)">
                <img src="http://s.hqbcdn.com/assets/v1/images/my/evaluate/eval_11.jpg" />
            </a> -->
            <button class="eval_smit btn btn-success" type="submit">提交</button>
        </div>
        {{csrf_field()}}
        </form>
    </div>
