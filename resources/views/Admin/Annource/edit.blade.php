 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/adminannource/{{$info->id}}" method="post"> 
     ...
     <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <script id="editor" name="descr" type="text/plain"  name="descr" style="width:700px;height:500px;">{{$info->descr}}</script>
       </div> 
      </div>
     </div> 
